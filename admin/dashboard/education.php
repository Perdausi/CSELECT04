                        ...
                        <div class="modal-content">
                            <form action="../query/education.query.php" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" type="text" name="attainment" placeholder="Attainment" required />
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#editModal_<?php echo $educ_id; ?>">
                                        ...
                                        <form action="../query/delete.education.php" method="POST" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this education record?');">
                                            <input type="hidden" name="educ_id" value="<?php echo $educ_id; ?>">
                                ...
                                <!-- Edit Modal -->
                                <div class="modal fade" id="editModal_<?php echo $educ_id; ?>" tabindex="-1" aria-labelledby="editModalLabel_<?php echo $educ_id; ?>" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="../query/education.update.php" method="POST">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editModalLabel_<?php echo $educ_id; ?>">Edit Education</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <input type="hidden" name="educ_id" value="<?php echo $educ_id; ?>">
                                                    <div class="form-floating mb-3">
                                                        <input class="form-control" type="text" name="school_name" value="<?php echo $row['school_name']; ?>" required />
                                                        <label>School Name</label>
                                                    </div>
                                                    <div class="form-floating mb-3">
                                                        <input class="form-control" type="text" name="attainment" value="<?php echo $row['attainment']; ?>" required />
